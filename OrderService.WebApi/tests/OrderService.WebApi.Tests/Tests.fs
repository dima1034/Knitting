...
let createHost() =
    WebHostBuilder()
        ...
        .Configure(Action<IApplicationBuilder> OrderService.WebApi.App.configureApp)
        .ConfigureServices(Action<IServiceCollection> OrderService.WebApi.App.configureServices)
