...
let createHost() =
    WebHostBuilder()
        ...
        .Configure(Action<IApplicationBuilder> OrderService.Api.App.configureApp)
        .ConfigureServices(Action<IServiceCollection> OrderService.Api.App.configureServices)
