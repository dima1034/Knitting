...
namespace OrderService.DataAccess.Specification.Base
{
    public class Specification<T> : ISpecification<T>
    {
        ...
        public static implicit operator Func<T, bool>(Specification<T> spec) { return spec.Function; }

        public static implicit operator Expression<Func<T, bool>>(Specification<T> spec) { return spec.Predicate; }

        public static bool operator true(Specification<T> spec) { return false; }

        public static bool operator false(Specification<T> spec) { return false; }
